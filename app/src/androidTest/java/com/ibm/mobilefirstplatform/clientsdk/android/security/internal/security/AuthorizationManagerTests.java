...
public class AuthorizationManagerTests extends InstrumentationTestCase {
	...
	public void setUp() throws Exception {
		super.setUp();
		AuthorizationManager.createInstance(getInstrumentation().getTargetContext());
	}

	public void testDefaultAppIdentity() throws Exception {

		JSONObject appIdentity = AuthorizationManager.getInstance().getAppIdentity();
	...
	public void testDefaultDeviceIdentity() throws Exception {
		...
		JSONObject deviceIdentity = AuthorizationManager.getInstance().getDeviceIdentity();
