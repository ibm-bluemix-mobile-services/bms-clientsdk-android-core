...
import com.ibm.bms.clientsdk.android.security.internal.certificate.CertificateStore;
import com.ibm.bms.clientsdk.android.security.internal.certificate.DefaultJSONSigner;
import com.ibm.bms.clientsdk.android.security.internal.certificate.KeyPairAuxiliary;
...
public class AuthorizationProcessManager {
    ...
    private void saveCertificateFromResponse(com.ibm.bms.clientsdk.android.core.api.Response response) throws JSONException, CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException {
    ...
    private void saveTokenFromResponse(com.ibm.bms.clientsdk.android.core.api.Response response) throws JSONException {
...
//    }
    ...
    private void handleAuthorizationSuccess(com.ibm.bms.clientsdk.android.core.api.Response response) {
